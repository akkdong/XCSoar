...
#ifndef XCSOAR_KOBO_PROMPT_WINDOW_HPP
#define XCSOAR_KOBO_PROMPT_WINDOW_HPP
...
class KoboPromptWindow final : public ContainerWindow {
...
public:
  ...
  KoboPromptWindow(const DialogLook &_look,
