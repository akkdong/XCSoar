...
MAKE_RESOURCE(IDB_EAGLE, 400);
MAKE_RESOURCE(IDB_EAGLE_HD, 5400);
MAKE_RESOURCE(IDB_FC_TITLE, 401);
MAKE_RESOURCE(IDB_FC_TITLE_HD, 5401);
MAKE_RESOURCE(IDB_LK8000, 402);
MAKE_RESOURCE(IDB_LK8000_HD, 5402);
MAKE_RESOURCE(IDB_KOBO_LAUNCHER1, 403);
MAKE_RESOURCE(IDB_KOBO_LAUNCHER2, 404);
